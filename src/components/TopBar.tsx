...
export function TopBar() {
  const [time, setTime] = React.useState('16:57');
  ...
  return (
    <div className="w-full flex justify-between items-center px-4 py-1 bg-screen-bg border-b-2 border-screen-header font-pixel text-screen-border transition-colors duration-500 relativ z-50">
